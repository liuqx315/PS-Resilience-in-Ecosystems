...
xlswrite("DDA_100",centroids1)
xlswrite("DDA_110",centroids2)
xlswrite("DDA_100vs110",dat)

Growth1=dat(:,9)-dat(:,2);
Growth2=dat(:,13)-dat(:,6);

figure('position', [100,10,2000,2000])
loglog(dat(:,2),Growth1,'o');
% hold on
...
% imshow(BWimg2)
% hold on
% text(dat(:,10)-8,dat(:,11),num2str(dat(:,8)),'Color','red','FontSize',5)
% saveas(gcf,'DDA_110.png')
